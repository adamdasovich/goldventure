...
const FEATURES = [
  {
    ...
    description:
      "Natural language queries across 500+ mining companies. Ask about resources, projects, financials — get instant, sourced answers.",
    badge: "AI",
    svgPath:
  ...
  },
  {
    ...
    description:
      "Comprehensive M&I resource tracking with NI 43-101 data, resource estimates, and economic studies for every tracked company.",
    badge: "Data",
    svgPath:
  ...
  },
  {
    title: "Metals Prices",
    description:
      "Real-time pricing for gold, silver, lithium, copper, rare earths, and battery metals with historical trends and alerts.",
    badge: "Markets",
    svgPath:
  ...
  },
  {
    ...
    description:
      "Feasibility data, economic studies, and project-level analytics to evaluate exploration and development stage companies.",
    badge: "Analytics",
    svgPath:
...
export default function Home() {
  ...
  const stat4 = useCountUp(43, 1800);
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative py-10 px-4 sm:px-6 lg:px-8 border-y border-slate-700/30">
        <div className="absolute inset-0 bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900"></div>
        <div className="relative max-w-5xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-0">
            <div className="stat-item text-center px-4" ref={stat1.ref}>
              <div className="text-3xl sm:text-4xl font-bold text-gradient-amber">
                {stat1.count}+
              </div>
            ...
            <div className="stat-item text-center px-4" ref={stat2.ref}>
              <div className="text-3xl sm:text-4xl font-bold text-gradient-amber">
                {stat2.count}+
              </div>
              <div className="text-sm text-slate-400 mt-1">
            ...
            <div className="stat-item text-center px-4" ref={stat3.ref}>
              <div className="text-3xl sm:text-4xl font-bold text-gradient-amber">
                {stat3.count}+
              </div>
              <div className="text-sm text-slate-400 mt-1">
            ...
            <div className="stat-item text-center px-4" ref={stat4.ref}>
              <div className="text-3xl sm:text-4xl font-bold text-gradient-amber">
                NI {stat4.count}-101
              </div>
              <div className="text-sm text-slate-400 mt-1">Report Analysis</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-slate">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-300 text-lg max-w-2xl mx-auto">
              Purpose-built tools for investors and companies in the junior
              mining sector.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {FEATURES.map((feature, idx) => (
              <Link key={idx} href={feature.href} className="block">
                <Card
                  variant="glass-card"
                  className="feature-card text-center h-full animate-slide-in-up"
                ...
                >
                  <CardHeader>
                    ...
                    <div className="feature-icon w-16 h-16 rounded-xl mx-auto mb-4 flex items-center justify-center bg-gold-500/15 border border-gold-500/30">
                      <svg
