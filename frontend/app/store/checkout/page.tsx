...
export default function CheckoutPage() {
  ...
  const handleCheckout = async () => {
    // Open the sign-in modal over the checkout rather than navigating away.
    // The old redirect pointed at /auth/login, a route this site does not
    // have, so a shopper who reached the payment step signed out was sent to a
            ...
            <div className="glass rounded-xl p-6 border border-blue-500/20 bg-gradient-to-r from-blue-900/20 to-slate-900">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-400">
                    Your cart contains only digital items. Download links will
                    be sent to your email address immediately after purchase.
                  </p>
                </div>
              </div>
            </div>
