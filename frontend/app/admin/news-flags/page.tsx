...
export default function NewsFlagsPage() {
  ...
  const handleOpenClosedFinancingModal = (flag: NewsReleaseFlag) => {
    setSelectedFlag(flag);
  ...
  const handleClosedFinancingCreated = () => {
    setShowClosedFinancingModal(false);
    setSelectedFlag(null);
    fetchFlags();
  };
  ...
  const handleCloseClosedFinancingModal = () => {
    setShowClosedFinancingModal(false);
    setSelectedFlag(null);
  };
  ...
  return (
    <div>
              ...
              <div className="flex items-start justify-between mb-4">
                ...
                {flag.status === 'pending' && (
                  <div className="flex gap-2 flex-wrap">
                    ...
                    <Button
                      variant="primary"
                      onClick={() => handleOpenClosedFinancingModal(flag)}
                      size="sm"
      ...
      {/* Create Closed Financing Modal - multi-step wizard for closed financings */}
      {showClosedFinancingModal && selectedFlag && (
        <CreateClosedFinancingModal
          flag={selectedFlag}
          accessToken={accessToken}
          onClose={handleCloseClosedFinancingModal}
          onCreateComplete={handleClosedFinancingCreated}
        />
      )}
