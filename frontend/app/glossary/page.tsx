...
const fallbackGlossaryTerms: GlossaryTerm[] = [
  {
    ...
    relatedLinks: [
      {
        text: "How to Read an NI 43-101 Report (Guide)",
        url: "/guides/how-to-read-ni-43-101-report",
      },
  ...
  },
  {
    ...
    category: "finance",
    relatedLinks: [{ text: "Explore TSXV Mining Stocks", url: "/companies" }],
  },
  {
    term: "Grade (g/t)",
    definition:
  ...
  },
  {
    ...
    relatedLinks: [
      {
        text: "PEA vs PFS vs DFS Explained (Guide)",
        url: "/guides/how-to-read-ni-43-101-report#pea-pfs-dfs",
      },
  ...
  },
  {
    ...
    relatedLinks: [
      {
        text: "Independent vs Internal QPs (Guide)",
        url: "/guides/how-to-read-ni-43-101-report#qualified-person",
      },
    ],
  },
  {
    ...
    relatedLinks: [
      {
        text: "Reserves vs Resources Explained (Guide)",
        url: "/guides/how-to-read-ni-43-101-report#reserves-vs-resources",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    relatedLinks: [
      {
        text: "Learn About Investor Qualification",
        url: "/financial-hub/qualification",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    category: "operations",
    relatedLinks: [{ text: "Browse Exploration Companies", url: "/companies" }],
  },
  {
...
export default function GlossaryPage() {
    ...
    const fetchGlossaryTerms = async () => {
      try {
        ...
        let nextUrl: string | null =
          `${process.env.NEXT_PUBLIC_API_URL}/glossary/?page_size=200`;
        ...
        while (nextUrl) {
          ...
          if (response.ok) {
            ...
            console.warn(
              "Failed to fetch glossary from API, using fallback data",
            );
  ...
  const schemaMarkup = {
    ...
    description:
      "Comprehensive glossary of technical terms, standards, and definitions used in junior gold mining, mineral exploration, NI 43-101 standards, TSXV listings, and mining investment. Essential resource for understanding mining terminology.",
    ...
    publisher: {
      ...
      description:
        "Junior gold mining data, stock intelligence, and industry analysis platform",
    },
    about: [
      {
        "@type": "Thing",
        ...
        <div className="bg-gradient-to-b from-slate-800 to-slate-900 border-b border-slate-700">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            {showSuccessMessage && (
              <div className="mb-4 p-4 bg-green-500/20 border border-green-500/50 rounded-lg">
                <p className="text-green-300 font-medium">
                  ✓ Term submitted successfully! Your submission will be
            ...
            <p className="text-xl text-slate-300 max-w-3xl">
              Essential terms and definitions for understanding junior gold
              mining, exploration, NI 43-101 standards, TSXV listings, and
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card variant="glass-card">
                <CardHeader>
                  ...
                  <CardDescription>
                    Explore junior gold mining companies with detailed technical
                    reports and resource estimates.
                  </CardDescription>
                  <a
                    href="/companies"
                    className="text-gold-400 hover:text-gold-300 mt-4 inline-block"
                  >
                    View All Companies →
                  </a>
                </CardHeader>
              ...
              <Card variant="glass-card">
                <CardHeader>
                  ...
                  <CardDescription>
                    Learn about private placements, accredited investor
                    requirements, and mining investment fundamentals.
                  </CardDescription>
                  <a
                    href="/financial-hub"
                    className="text-gold-400 hover:text-gold-300 mt-4 inline-block"
              ...
              <Card variant="glass-card">
                <CardHeader>
                  ...
                  <CardDescription>
                    Browse exploration properties, mining projects, and mineral
                    claims available for partnership or sale.
                  </CardDescription>
                  <a
                    href="/properties"
                    className="text-gold-400 hover:text-gold-300 mt-4 inline-block"
