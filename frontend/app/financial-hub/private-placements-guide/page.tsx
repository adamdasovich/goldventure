      ...
      pricingDetails: [
        {
          ...
          description:
            "Most private placements are priced at a discount to market (typically 10-25%) to compensate investors for the hold period and illiquidity risk.",
        },
        {
          term: "TSX Venture Pricing Rules",
          description:
            "The TSX Venture Exchange requires a minimum price of $0.05 and limits discounts based on market capitalization and trading history.",
        },
        {
          term: "Warrant Strike Price",
          description:
            "Warrants are typically priced at a premium to the placement price (often 25-50% higher), providing investors with leveraged upside.",
        },
        {
          term: "Flow-Through Premium",
          description:
            "Flow-through shares are priced at a premium (typically 15-30%) to compensate for the tax benefits being transferred.",
        },
      ],
    },
    {
      ...
      regulations: [
        {
          ...
          description:
            "Prospectus Exemptions - defines who can participate and under what conditions",
        },
        {
          name: "National Instrument 43-101",
          description:
            "Standards for mineral project disclosure to ensure technical information is reliable",
        },
        {
          name: "TSX/TSX-V Policies",
          description:
            "Exchange-specific rules governing pricing, dilution limits, and approval requirements",
        },
        {
          name: "Resale Restrictions",
          description:
            "National Instrument 45-102 governs the 4-month hold period and resale conditions",
        },
      ],
    },
  ];
      ...
      <section className="relative py-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="font-display text-2xl sm:text-3xl md:text-4xl font-semibold mb-4 text-gold-400 tracking-tight italic">
              Private Placements Guide
            </h1>
            <p className="text-xl text-slate-300 max-w-2xl mx-auto mb-4">
              Understanding how junior mining companies raise capital and how
              you can participate in private placement financings.
            </p>
            <p className="text-sm text-slate-400 max-w-2xl mx-auto">
              Looking for the broader context? See the pillar guide:{" "}
              <a
              ...
              — covers all financing structures (placements, bought deals,
              flow-through, warrants, ATMs, streams, royalties) with worked
              dilution math.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto space-y-12">
                  ...
                  <div className="space-y-6">
                    {section.steps.map((step) => (
                      <div key={step.number} className="flex gap-4">
                        <div
                          className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 font-bold text-slate-900"
          ...
          <div className="p-8 backdrop-blur-sm bg-gradient-to-r from-gold-400/10 to-gold-600/10 border border-gold-400/30 rounded-xl text-center">
            ...
            <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
              Complete your accredited investor qualification to access active
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <Button
                ...
                size="lg"
                onClick={() =>
                  router.push("/financial-hub/subscription-agreements-guide")
                }
              >
      ...
      <footer className="py-8 px-4 border-t border-slate-800">
        <div className="max-w-7xl mx-auto text-center text-slate-400 text-sm">
          ...
          <p className="mt-2 text-xs">
            ...
            constitute legal or financial advice. Always consult with qualified
