        ...
        <div className="container mx-auto px-4 py-12 max-w-3xl">
          ...
          <div className={`p-8 rounded-xl shadow-md ${
            ...
            {existingQualification.status === 'qualified' && existingQualification.qualified_at && (
              <div className="mt-6 p-4 bg-white dark:bg-green-900/10 rounded-lg">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-md p-8">
          {step === 1 && (
            <div>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start gap-4">
                        <div className={`p-3 rounded-lg ${isSelected ? 'bg-blue-600' : 'bg-slate-100 dark:bg-slate-700'}`}>
              ...
              <button
                onClick={() => setStep(2)}
                className="mt-8 w-full px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all"
              >
                Continue
              </button>
            </div>
          ...
          {step === 2 && formData.investor_type === 'individual' && (
            <div>
              ...
              <div className="mt-8 flex gap-4">
                <button
                  onClick={() => setStep(1)}
                  className="flex-1 px-6 py-3 border-2 border-slate-300 dark:border-slate-600 text-slate-700 dark:text-slate-300 font-semibold rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors"
                >
                  Back
                </button>
                <button
                  ...
                  disabled={submitting}
                  className="flex-1 px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all disabled:opacity-50"
                >
