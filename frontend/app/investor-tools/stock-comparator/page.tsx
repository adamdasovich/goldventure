      ...
      <section className="py-8 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#0a0e1a] to-slate-900">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-slate-300 max-w-xl mx-auto">
            Compare the share-price performance of up to 10 junior mining
            companies side by side. Curves are normalized to 0% at the start of
            the window so they&apos;re directly comparable.
          </p>
        </div>
      </section>
