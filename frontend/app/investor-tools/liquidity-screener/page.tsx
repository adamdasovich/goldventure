      ...
      <section className="py-10 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#0a0e1a] to-slate-900">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-slate-300 max-w-3xl">
            How long it would actually take to sell a position. Most junior
            listings trade so thinly that an ordinary retail position cannot be
            exited in any reasonable time — and no other screener shows it.
          </p>
        </div>
      </section>
