      ...
      <section className="py-8 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#0a0e1a] to-slate-900">
        <div className="max-w-7xl mx-auto text-center">
          <Badge variant="gold" className="mb-3">
            Commodity Leverage Analysis
          </Badge>
          <h1 className="text-3xl sm:text-4xl font-bold text-gradient-gold mb-3">
            Metal Leverage Analyzer
          </h1>
          <p className="text-slate-300 max-w-2xl mx-auto">
            Measure how tightly each company&apos;s stock tracks a chosen metal
            price, and how much it amplifies that metal&apos;s moves.
            Correlation, beta, R², and a volatility-based leverage ratio across
            up to 10 companies side by side.
          </p>
        </div>
      </section>
