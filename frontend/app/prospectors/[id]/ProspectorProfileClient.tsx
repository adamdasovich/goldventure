...
export default function ProspectorProfileClient({
  params,
}: {
    ...
    const fetchProfile = async () => {
      ...
      try {
        ...
        const profileRes = await fetch(
          `${API_URL}/properties/prospectors/${resolvedParams.id}/`,
        );
        if (!profileRes.ok) {
        ...
        const listingsRes = await fetch(
          `${API_URL}/properties/listings/?prospector=${resolvedParams.id}&status=active`,
        );
        if (listingsRes.ok) {
      ...
      <div className="min-h-screen">
        ...
        <div className="max-w-4xl mx-auto py-16 px-4 text-center">
          ...
          <p className="text-slate-400 mb-8">
            {error ||
              "The prospector profile you're looking for doesn't exist."}
          </p>
          <Button
            variant="primary"
            onClick={() => (window.location.href = "/properties")}
          ...
          <div className="flex flex-col md:flex-row items-start gap-8">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                ...
                {profile.is_verified && <Badge variant="gold">Verified</Badge>}
              </div>
              ...
              <p className="text-slate-400 mb-4">
                ...
                {profile.verification_date &&
                  ` • Verified since ${formatDate(profile.verification_date)}`}
              </p>
              ...
              <Card className="p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {profile.specializations.map((spec, index) => (
                    <Badge key={index} variant="copper">
                      {spec}
                    </Badge>
                  ))}
                </div>
