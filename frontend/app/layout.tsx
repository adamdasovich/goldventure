...
const organizationJsonLd = {
  ...
  description:
    "AI-powered platform for junior mining company analysis covering gold, silver, lithium, copper, rare earths, and critical minerals. Investment research and market intelligence for precious metals and battery metals.",
  about: [
    {
      "@type": "Thing",
  ...
  mentions: {
    ...
    description:
      "Canadian National Instrument 43-101 standards for mineral resource reporting",
  },
  contactPoint: [
    {
      "@type": "ContactPoint",
    ...
    itemListElement: [
      ...
      },
      {
        ...
        itemOffered: {
          ...
          description:
            "Access to technical reports and mineral resource estimates",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          ...
          description:
            "Real-time precious metals pricing, financing data, and exploration updates",
        },
      },
    ],
  },
...
const websiteJsonLd = {
  ...
  url: "https://juniorminingintelligence.com",
  description:
    "Discover and analyze junior mining companies exploring gold, silver, lithium, copper, and critical minerals with AI-powered insights.",
  potentialAction: {
    "@type": "SearchAction",
    target: {
      "@type": "EntryPoint",
      urlTemplate:
        "https://juniorminingintelligence.com/companies?search={search_term_string}",
    },
...
const financeServiceJsonLd = {
  ...
  url: "https://juniorminingintelligence.com",
  description:
    "Mining investment research platform providing company analysis for gold, silver, lithium, copper, rare earths, and critical minerals. Includes precious metals pricing and investment qualification services.",
  address: {
    "@type": "PostalAddress",
    addressCountry: "CA",
  },
